...
function AISavingsSimulatorPage() {
  return (
    <div className="relative space-y-8 pb-8 animate-fade-in">
      ...
      <div className="flex items-center gap-2">
        <BackButton to="/ai/savings" />
        <AIPageHeader title="Simulador de Ahorros" subtitle="Proyecta tus ahorros con diferentes parametros" className="flex-1" />
      </div>
...
export default AISavingsSimulatorPage
